...
from vllm.entrypoints.openai.api_server import (ErrorResponse, base, build_app,
                                                build_async_engine_client,
                                                init_app_state,
                                                load_log_config, logger,
                                                setup_server,
...
from vllm_tei_plugin.entrypoints.openai.serving_tei_embed import \
    TeiServingEmbed
from vllm_tei_plugin.entrypoints.openai.serving_tei_rerank import \
    TeiServingRerank
